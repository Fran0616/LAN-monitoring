...
room_000 = "-c1 add_hostname" #variable is for indicating the host name you wish to ping and -c1 means send one ping
response_000 = os.system("ping " + room_000) ##add ping plus the variable above 
room_001 = "-c1 add_hostname" #variable is for indicating the host name you wish to ping and -c1 means send one ping
response_001 = os.system("ping " + room_001) ##add ping plus the variable above 
...
def zero_floor():
    ...
    if response_001 == 0: 
        print ('Room_001 printer is up')
    else:
        print ('Room_001 printer down') 
